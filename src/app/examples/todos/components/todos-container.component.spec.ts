...
describe('TodosComponent', () => {
  ...
  const getBigInput = () =>
    fixture.debugElement.query(By.css('niffler-big-input'));
  ...
  const deleteDoneTodosBtn = () =>
    fixture.debugElement.query(
      By.css('niffler-big-input-action[fontIcon="fa-trash"] > button')
    );

  const addTodoBtn = () =>
    fixture.debugElement.query(
      By.css('niffler-big-input-action[fontIcon="fa-plus"] > button')
    );
