...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<niffler-big-input-action></niffler-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<niffler-big-input-action [disabled]="true"></niffler-big-input-action>';
    fixture = createHostComponent(template);
    expect(getButton().nativeElement.disabled).toBeTruthy();
  });

  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template = `<niffler-big-input-action fontSet="fas" fontIcon="fa-trash"></niffler-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template = `<niffler-big-input-action label="delete"></niffler-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template = `<niffler-big-input-action (action)="actionHandler()"></niffler-big-input-action>`;
    fixture = createHostComponent(template);
